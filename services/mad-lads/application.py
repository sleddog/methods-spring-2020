...
def randomFacts():
    ...
    facts = {
        ...
        "cows": 'Cows painted with zebra-like stripes can avoid being bitten by flies.',
        "Mantis shrimp": 'The mantis shrimp has the worlds fastest punch.',
        "mantis shrimp": 'The mantis shrimp has the worlds fastest punch.',
        ...
        "the bumblebee bat": "is the smallest bat in the world",
        "Kittis Hog-Nosed Bat": "is known as the bumblebee bat",
        "kittis hog-nosed bat": "is known as the bumblebee bat",
    ...
    insults = {1: 'Yo mommas so stupid, she put two quarters in her ears and thought she was listening to 50 Cent.',
               2: 'Test', 3: 'test1'}
    ...
    if animal == "human":
        ...
        try:
            ...
            ret = "Animal doesn't exist mate"
    return f'Random facts about {escape(animal)}: {escape(ret)}!'
