...
def randomFacts():
    ...
    facts = {
		"Cows": 'Cows painted with zebra-like stripes can avoid being bitten by flies.', "cows": 'Cows painted with zebra-like stripes can avoid being bitten by flies.',
	...
	insults={1:'Yo mommas so stupid, she put two quarters in her ears and thought she was listening to 50 Cent.',2:'Test',3:'test1'}
