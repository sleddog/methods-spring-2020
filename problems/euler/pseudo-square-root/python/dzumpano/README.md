psr is a simple program designed to find the GCD that is less than the square root of a large prime. As long as you have IDLE on your machine it should run fine.
